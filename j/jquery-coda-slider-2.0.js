...
(function($j){
	// Preloader
	$j(".coda-slider").children('.panel').hide().end().prepend('<p class="loading">Loading...<br /><img src="/wp-content/themes/SMPWide/j/images/ajax-loader.gif" alt="loading..."/></p>');
});
...
$j.fn.codaSlider = function(settings) {
	...
	settings = $j.extend({
		...
		autoHeightEaseFunction: "easeOutBack",
		autoSlide: false,

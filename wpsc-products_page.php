...
<div id=topbar>
	<div id="topleftcell">
		<a href="<?php bloginfo('url'); ?>/freebies" title="Git yer Free tracks 'ere" target="_self"><img src="<?php bloginfo('template_directory'); ?>/images/internal/rotator.php" alt="Free Tracks" /></a>
	</div>
	<!-- end topleftcell -->  
	  ...
	  <?php if(wpsc_category_grid_view()) :?>
		  ...
		  <?php else:?>
			...
			<?php wpsc_start_category_query(array('category_group'=>get_option('wpsc_default_category'), 'show_thumbnails'=> get_option('show_category_thumbnails'))); ?>
				<li><?php wpsc_print_category_image(get_option('category_image_width'), get_option('category_image_height')); ?>		
	...
	<!--  end buckle-->
	<div id="toprightcell">
		<a href="<?php bloginfo('url'); ?>/freebies" title="Brand New! Stable Tracks" target="_self"><img src="<?php bloginfo('template_directory'); ?>/images/internal/rotator2.php" alt="Free Tracks" /></a>
	</div>
	<!-- end toprightcell -->
</div>
<!-- end topbar-->
<div id="belt">
	<div id="lpanel_tl" class="lpane">
		<h2 id="listing_h2">Tracks</h2>
        <div>
			<a class="prev">prev</a>
		</div>
		<div class="carousel">
        	<ul id="stb_ul" class="stab_listing">
           	<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
           		<li class="tl">
        			<a class="xtrig" rel="coda-slider-1" href="#"><?php echo wpsc_the_product_title();?></a>
        		</li>
        	<?php endwhile ?>
        	</ul>
		</div>
				...
				<h2 class="prodtitle entry-title">
					...
					<div class="wpsc_description">
						...
						<div class="additional_description_container">
							<img class="additional_description_button"  src="<?php echo WPSC_CORE_THEME_URL; ?>wpsc-images/icon_window_expand.gif" alt="Additional Description" /><a href="<?php echo wpsc_the_product_permalink(); ?>" class="additional_description_link"><?php _e('TRACK PLAYER', 'wpsc'); ?>
							</a>
								...
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
										<div class="wpsc_loading_animation">
											...
											<?php else: ?>
										<input type="image" src='<?php bloginfo('template_url'); ?>/wpsc-images/ibuynow.png' value="<?php _e('Add To Cart', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/>
											<?php endif; ?>
